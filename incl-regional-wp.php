...
<select name="tregional_num" onchange="updategoButton(\'false\',this.value,\'' . esc_attr( $nonce ) . '\',\'' . esc_attr( $category_id ) . '\'), showSubLoc1(this.value,\'' . esc_attr( $nonce ) . '\',1,\'' . esc_attr( $category_id ) . '\',\'regions\')"><option value="">' . esc_attr( WORDING_AJAX_REGIONAL_MENU1 ) . '</option> ';
