...
if($error_array[0]== 'yes'){ echo '<br>You\'re link id number is misconfigured'; }
if($error_array[1]== 'yes'){ echo '<br>You\'re agent id number is misconfigured'; }
if($error_array[2]== 'yes'){ echo '<br>You\'re agent url is misconfigured'; }
if($error_array[3]== 'yes'){ echo '<br>You\'re agent folder name is misconfigured'; }
if($error_array[4]== 'yes'){ echo '<br>You\'re installer id number is misconfigured'; }
}
else
{
...
echo '<div style="width:75%;margin: 0 auto; "><h3><a  style="color:blue; text-decoration: underline;" href="/wp-admin/admin.php?page=manna-network">RETURN</a></h3></div><br>';
get_footer();
